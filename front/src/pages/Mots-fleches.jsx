...
export default function MotFleches() {
  ...
  const [finalResult, setFinalResult] = useState(null); // { correct: number, wrong: number, totalScore: number }
  ...
  const totalScore = useMemo(() => {
    ...
    // Pendant le jeu : juste le score temps
  ...
  const abandonGame = () => {
    ...
    setWordDelta(0);
    stopTimer();
    setStatusText("Partie abandonnée → score = 0");
  };
        ...
        <div className="side-panel panel-right animate-fade-in delay-2">
          <div className="info-card">
            ...
            {isGameFinished && finalResult ? (
              ...
              <div className="status-badge lost">Partie abandonnée → 0</div>
            ) : gameId ? (
